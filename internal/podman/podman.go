...
type Config struct {
	...
	InitDir    string `toml:"init_dir"`
	ConfigsDir     string `toml:"configs_dir"`
	BrowserDir     string `toml:"browser_dir"`
	BrowserInitDir string `toml:"browser_init_dir"`
	...
	PixelfluxWayland bool   `toml:"pixelflux_wayland"`
	DRINode          string `toml:"drinode"`
	ShmSize          string `toml:"shm_size"`
	BrowserShmSize   string `toml:"browser_shm_size"`
}
...
// run executes podman with the given arguments.
