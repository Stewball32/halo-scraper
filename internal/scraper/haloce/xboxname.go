...
// Distinctive 28-byte prefix observed before every heap-allocated XString copy
// of the local xbox console name. Made up of kernel pointers that should be
// deterministic across xemu boots (XBE loads at a fixed base, kernel imports
// resolve the same way each time).
